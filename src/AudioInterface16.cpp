...
struct AudioInterface16Widget : ModuleWidget {
	...
	AudioInterface16Widget(TAudioInterface *module) {
		setModule(module);
		setPanel(APP->window->loadSvg(asset::plugin(pluginInstance, "res/AudioInterface16_Plastic.svg")));
...
Model *modelAudioInterface16 = createModel<rcm::AudioInterface<16, 16>, rcm::AudioInterface16Widget>("AudioInterface16");
